            ...
            <div className='row'>
                ...
                <div className='col-12 col-lg-6 left-text'>
                    ...
                    <p className='section-p'>
                        At Transblue, our team of landscape architects and designers and put your plans to paper to design a beautiful landscape. Our projects are  cost effective and add beautification to your property, no matter the size.
                    </p>
                    <p className='section-p'>
