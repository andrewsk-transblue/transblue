...
import handshake from '../../images/subcontractor/handshake.png';
import './style.css';
                ...
                <div className=' col-md-4 col-lg-4 pl-lg-5'>
                    <div className='row'>
                        <div className='col-3 col-sm-2 col-md-12 col-sm-2 col-lg-12'>
                            <img src={handshake} alt='' style={{width: '100px'}} />
                        </div>
                        <div className='col-9 col-sm-10 col-md-12 col-sm-10 col-lg-12'>
                            <p>We promise to treat you the way we want to be treated. We promise to always be fair, courteous, and respectful.</p>
                        </div>
                    </div>
                </div>
                <div className=' col-md-4 col-lg-4 pl-lg-5'>
