        ...
        <div className='container commercial-about'>
            <div className='row'>
                <div className='col-lg-6 order-lg-12 left-text'>
                    ...
                    <p className='section-p'>When working with Transblue, you can experience a company focused on the customer experience. We strive to provide a World Class experience for both you and your customer. Ensuring they don’t lose faith in your brand is a mission critical concentration when fulling the project deliverables.</p>
