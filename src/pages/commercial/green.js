    ...
    return(
        <div className='container-fluid green-solns'>
            ...
            <div className='col-lg-4 col-md-6'>
                    ...
                    <p className='hospitality-subheader'>SOLAR PANELS</p>
                ...
                <div className='col-lg-4 col-md-6'>
                    ...
                    <p className='hospitality-subheader'>ELECTRIC VEHICLE CHARGERS</p>
                ...
                <div className='col-lg-4 col-md-6'>
                    ...
                    <p className='hospitality-subheader'>POROUS ASPHALT</p>
                    <p className='section-p mb-4'>Provide green solutions for your employees and contribute to creating a greener world</p>
                </div>
            </div>
        </div>
